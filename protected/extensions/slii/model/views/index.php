...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'guessRelations'); ?>
        <?php echo $form->checkBox($model,'guessRelations'); ?>
        <div class="tooltip">
            Угадываем взаимосвязи по полям.
        </div>
        <?php echo $form->error($model,'guessRelations'); ?>
    </div>
